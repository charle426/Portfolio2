export default function Resume(){
    return(
        <section
        id="resume"
        className="py-[50px] my-12 rounded-3xl px-3 bg-accent"
      >
        <div className="flex flex-col items-center justify-center w-full text-center ">
          <h1 className="sm:text-[2.5em] text-[2rem] font-semibold">RESUME</h1>
          <p className="max-w-[700px]"></p>
          <div className="h-[2px] mt-5 w-[110px] bg-accent-200 mb-[30px] flex justify-center items-center">
            <div className="h-[4px] w-[40px] bg-primary"></div>
          </div>
        </div>
        <div className="flex w-full flex-col md:flex-row md:pl-20 gap-8">
          <div className="flex flex-col gap-8">
            <div>
              <h3 className="text-[35px] font-semibold mb-3">Summary</h3>
              <div className="pl-4 relative border-primary border-l-2">
                <div className="resume-info relative">
                  <p className="text-primary text-[25px] mb-5 font-semibold leading-none">
                    Akachukwu Uzoma
                  </p>
                ...
                <div>
                  ...
                  <div className="resume-info relative">
                    ...
                    <p className="max-w-[350px] mb-4">
                      ...
                      I already knew frontend technologies so I helped teach
                      fellows about frontend after classes and i graduated a
                  ...
                  <div className="resume-info relative">
                    ...
                    <p className="max-w-[350px] mb-4">
                      ...
                      scrimba and other great tools learn then built a lot of
              ...
              <div>
                <div className="resume-info relative">
                  ...
                  <ul className="list-disc list-outside p-3 max-w-[500px] flex flex-col gap-3">
                    ...
                    <li>
                      I get most of my freelance jobs from Upwork and Fiverr
                    </li>
                  </ul>
                </div>
                <div className="resume-info relative">
